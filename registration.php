            ...
            <section class="contact-page inner-page">
               <div class="container">
                  <div class="row">
                     ...
                     <!-- WHY? -->
                     <div class="col-md-4">
                        <h4>Order Online in a fast and easy way</h4>
                        <p>Once you're sign in, you can:</p>
                        <hr>
                        <img src="images/img20.jpg" alt="" class="img-fluid">
                        <p></p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>A proudly homegrown concept from the Queen City of Bicol, Naga City is Bigg's Diner country.

                             </a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body"> <strong>With over sixteen branches and even more planned in the pipeline, Bigg's Diner is definitely big in Bicol.</strong> <br> </div>
                           </div>
                        </div>
                        <!-- end:panel -->
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Most dishes are served with equally tasty sides at Bigg's Diner to complete your meal, from spicy Kimchi, Coleslaw, and Side Salad.</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq2" aria-expanded="true" role="article">
                              <div class="panel-body"> locals have a craving for chicken and ribs, Bigg's Diner is top-of-mind in Bicol. Perfectly crisp outside and juicy inside. </div>
                           </div>
                        </div>
                        <!-- end:Panel -->
